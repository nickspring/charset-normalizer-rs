...
lazy_static! {
    pub static ref BOM_UTF8: Vec<u8> = vec!(0xef, 0xbb, 0xbf);
    pub static ref BOM_UTF16_BE: Vec<u8> = vec!(0xfe, 0xff);
    pub static ref BOM_UTF16_LE: Vec<u8> = vec!(0xff, 0xfe);
    pub static ref BOM_UTF32_BE: Vec<u8> = vec!(0x00, 0x00, 0xfe, 0xff);
    pub static ref BOM_UTF32_LE: Vec<u8> = vec!(0xff, 0xfe, 0x00, 0x00);

    // Contain for each eligible encoding a list of/item bytes SIG/BOM
    pub static ref ENCODING_MARKS: HashMap<&'static str, Vec<Vec<u8>>> = hashmap!{
        "utf_8" => vec!(
            BOM_UTF8.clone()
        ),
        "utf_7" => vec!(
            vec!(0x2b, 0x2f, 0x76, 0x38),
            vec!(0x2b, 0x2f, 0x76, 0x39),
            vec!(0x2b, 0x2f, 0x76, 0x2b),
            vec!(0x2b, 0x2f, 0x76, 0x2f),
            vec!(0x2b, 0x2f, 0x76, 0x38, 0x2d),
        ),
        "gb18030" => vec!(
            vec!(0x84, 0x31, 0x95, 0x33),
        ),
        "utf_32" => vec!(
            BOM_UTF32_BE.clone(),
            BOM_UTF32_LE.clone()
    ...
    pub static ref UTF8_MAXIMAL_ALLOCATION: usize = 1112064;

    pub static ref UNICODE_RANGES_COMBINED: HashMap<&'static str, Range<u32>> = hashmap!{
    ...
    pub static ref UNICODE_SECONDARY_RANGE_KEYWORD: [&'static str; 15] = [
        "Supplement",
        "Extended",
        "Extensions",
        "Modifier",
    ...
    pub static ref COMMON_SAFE_ASCII_CHARACTERS: [&'static str; 15] = [
        "<",
        ">",
        "=",
        ":",
    ...
    pub static ref RE_POSSIBLE_ENCODING_INDICATION: Regex = Regex::new(
    ...
    // additional Korean encodings
    pub static ref KO_NAMES: [&'static str; 1] = [
        "euc-kr",
    ];

    // additional Chinese encodings
    pub static ref ZH_NAMES: [&'static str; 4] = [
        "big5",
        "hz",
        "gbk",
        "gb18030",
